...
/*
	...
	if (background_y == -1000) {
		App->enemies->AddEnemy(ENEMY_TYPES::TORPEDO, 70, 0, ENEMY_MOVEMENT::TORPEDO_STRAIGHT_ON);
		App->enemies->AddEnemy(ENEMY_TYPES::TORPEDO, 120, 0, ENEMY_MOVEMENT::TORPEDO_STRAIGHT_ON);
	
		App->enemies->AddEnemy(ENEMY_TYPES::TORPEDO, 50, -90, ENEMY_MOVEMENT::TORPEDO_STRAIGHT_ON);
		App->enemies->AddEnemy(ENEMY_TYPES::TORPEDO, 140, -90, ENEMY_MOVEMENT::TORPEDO_STRAIGHT_ON);
		App->enemies->AddEnemy(ENEMY_TYPES::TORPEDO, 10, -90, ENEMY_MOVEMENT::TORPEDO_STRAIGHT_ON);
		App->enemies->AddEnemy(ENEMY_TYPES::TORPEDO, 180, -90, ENEMY_MOVEMENT::TORPEDO_STRAIGHT_ON);
	}
